...
def parse_option():
    ...
    if opt.model in ['MobileNetV2', 'ShuffleV1', 'ShuffleV2', 'plane2', 'plane4', 'plane6', 'plane8','plane10']:
...
def main():
    ...
    # tensorboard
    wandb.init(project="distill_image", name="train_teacher")
    ...
    for epoch in range(1, opt.epochs + 1):
        ...
        if test_acc > best_acc:
            ...
            acc_save_path = os.path.join(opt.save_folder, '{}_best_acc.txt'.format(opt.model))
